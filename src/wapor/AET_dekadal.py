...
def main(Dir, Startdate='2009-01-01', Enddate='2018-12-31',
    ...
    """
    print('\nDownload dekadal WaPOR Actual Evapotranspiration data for the period %s till %s' % (
        Startdate, Enddate))

    # Download data
    WaPOR.API.version = version
    catalog = WaPOR.API.getCatalog(level=level)
    ...
    for index, row in df_avail.iterrows():
        ...
        filename = 'AETI_WAPOR.v%s_mm-dekad-1_%s.tif' % (
